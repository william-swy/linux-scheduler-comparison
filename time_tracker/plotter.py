...
res = open('gzip_original_eevdf', 'r').read()
...
# plt.plot(gzip_utime_list, gzip_sum_exec, label="gzip")
...
plt.plot(gzip_utime_list, gzip_vruntime, label="gzip")
...
# plt.plot(gzip_utime_list, ideal_usage, label="gzip ideal fair usage")
